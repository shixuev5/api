    ...
    <section>
      ...
      <a-form layout="inline">
        <a-form-item>
          ...
          <a-input-number v-model="value.maximum" style="width: 200px;" />
        </a-form-item>
        <a-form-item>
        ...
        <a-form-item>
          ...
          <a-input-number v-model="value.minimum" style="width: 200px;" />
        </a-form-item>
        <a-form-item>
        ...
        <a-form-item>
          ...
          <a-input-number v-model="value.multipleOf" style="width: 200px;" />
        </a-form-item>
        <br />
        <a-form-item>
